...
import dash
from dash import html, dcc, callback, Output, Input, State, MATCH, ALL, ClientsideFunction
    ...
    try:
        ...
        try:
            ...
            for k in fon_kodlari_list:
                ...
                if not info:
                    try:
                        anlik = _tefas_api.fon_anlik_bilgi(k) or {}
...
def _build_metrics_table(fund_dict: dict, mix_series: pd.Series = None, mix_name: str = None, fon_benchmark_series: dict = None, fon_benchmark_sources: dict = None, fon_benchmark_correlations: dict = None):
    ...
    from config.constants import (
        ...
        METRIC_M2,
        METRIC_REAL_RETURN,
        METRIC_CONSUMER_INFLATION,
        METRIC_MWR_RETURN,
        METRIC_IRR,
        METRIC_SYSTEMATIC_TE,
        METRIC_IDIOSYNCRATIC_TE,
    )
...
# ── Callback: favorileri goster ──────────────────────────────────────
@callback(
    Output("fav-section", "children"),
...
dash.clientside_callback(
    ClientsideFunction(
        ...
        function_name='update_home_charts'
    ),
